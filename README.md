...
[![Python 3.7+](https://img.shields.io/badge/python-3.10+-blue.svg)](https://www.python.org/downloads/release/python-370/) ![pre-commit](https://img.shields.io/badge/pre--commit-enabled-brightgreen?logo=pre-commit) [![pre-commit-version](https://img.shields.io/badge/pre--commit-3.8.0-yellow)](https://github.com/pre-commit/pre-commit)
