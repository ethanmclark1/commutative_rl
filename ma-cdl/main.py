...
if __name__ == '__main__':
    ...
    seed, approaches, max_elements, action_dims, problem_instances, reward_type, reward_noise_variance = get_arguments(num_instances, remaining_argv)
    ...
    approaches = [approach_map[name](seed, num_instances, max_elements, action_dims, reward_type, reward_noise_variance) for name in approaches]
